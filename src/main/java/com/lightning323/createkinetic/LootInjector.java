...
//            System.out.println("Adding totem loot to " + event.getName().getPath());
            ...
            LootPool pool = LootPool.lootPool()
                    .add(LootItem.lootTableItem(AllItems.SHIP_TOTEM.get()).setWeight(shipTotemChance))//X% change of ship totem
                    .add(LootItem.lootTableItem(AllItems.FREEZE_SHIP_TOTEM.get()).setWeight(freezeTotemChance))//Y% change of freeze totem
