...
//            System.out.println("Adding totem loot to " + event.getName().getPath());
            ...
            LootPool pool = LootPool.lootPool()
                    .add(LootItem.lootTableItem(KineticItems.SHIP_TOTEM.get()).setWeight(shipTotemChance))//X% change of ship totem
                    .add(LootItem.lootTableItem(KineticItems.FREEZE_SHIP_TOTEM.get()).setWeight(freezeTotemChance))//Y% change of freeze totem
