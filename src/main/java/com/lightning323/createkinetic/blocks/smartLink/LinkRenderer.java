...
public class LinkRenderer {
	...
	public static void tick() {
		...
		com.simibubi.create.content.redstone.link.LinkBehaviour behaviour = BlockEntityBehaviour.get(world, pos, com.simibubi.create.content.redstone.link.LinkBehaviour.TYPE);
		if (behaviour == null)
			return;
	...
	public static void renderOnBlockEntity(SmartBlockEntity be, float partialTicks, PoseStack ms,
		...
		com.simibubi.create.content.redstone.link.LinkBehaviour behaviour = be.getBehaviour(LinkBehaviour.TYPE);
		if (behaviour == null)
			return;
