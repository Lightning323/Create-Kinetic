...
public class LinkedControllerItemRenderer extends CustomRenderedItemModelRenderer {
	...
	static void tick() {
		...
		boolean active = com.simibubi.create.content.redstone.link.controller.LinkedControllerClientHandler.MODE != Mode.IDLE;
		...
		for (int i = 0; i < buttons.size(); i++) {
			...
			lerpedFloat.chase(com.simibubi.create.content.redstone.link.controller.LinkedControllerClientHandler.currentlyPressed.contains(i) ? 1 : 0, .4f, Chaser.EXP);
	...
	protected static void render(ItemStack stack, CustomRenderedItemModel model,
		...
		if (renderType == RenderType.NORMAL) {
			...
			active &= com.simibubi.create.content.redstone.link.controller.LinkedControllerClientHandler.MODE != Mode.IDLE;
