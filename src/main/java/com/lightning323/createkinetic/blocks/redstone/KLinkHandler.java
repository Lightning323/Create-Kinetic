...
public class KLinkHandler {
    ...
    public static void onBlockActivated(PlayerInteractEvent.RightClickBlock event) {
        ...
        KLinkBehaviour behaviour = BlockEntityBehaviour.get(world, pos, KLinkBehaviour.TYPE);
        if (behaviour == null)
            return;
        ...
        for (boolean first : Arrays.asList(false, true)) {
            //THIS IS HOW NEW ITEM GETS SELECTED ON LINKED CONTROLLER (ITS NOT LINKED CONTROLLER BLOCK USE)
