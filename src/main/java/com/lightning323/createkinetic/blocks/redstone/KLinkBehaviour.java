...
public class KLinkBehaviour extends BlockEntityBehaviour implements KIRedstoneLinkable, ClipboardCloneable {

    public static final BehaviourType<KLinkBehaviour> TYPE = new BehaviourType<>();
    ...
    protected KLinkBehaviour(SmartBlockEntity be, Pair<ValueBoxTransform, ValueBoxTransform> slots) {
        super(be);
        frequencyFirst = KFrequency.EMPTY;
        frequencyLast = KFrequency.EMPTY;
    ...
    public static KLinkBehaviour receiver(SmartBlockEntity be, Pair<ValueBoxTransform, ValueBoxTransform> slots,
                                          IntConsumer signalCallback) {
        KLinkBehaviour behaviour = new KLinkBehaviour(be, slots);
        behaviour.signalCallback = signalCallback;
        behaviour.mode = Mode.RECEIVE;
        return behaviour;
    }

    public static KLinkBehaviour transmitter(SmartBlockEntity be, Pair<ValueBoxTransform, ValueBoxTransform> slots,
    ...
    public KLinkBehaviour moveText(Vec3 shift) {
        textShift = shift;
        return this;
    }

    public void copyItemsFrom(KLinkBehaviour behaviour) {
        if (behaviour == null)
            return;
    ...
    public void notifySignalChange() {
        CreateKinetic.REDSTONE_LINK_NETWORK_HANDLER.updateNetworkOf(getWorld(), this);
    }
    ...
    public void read(CompoundTag nbt, boolean clientPacket) {
        ...
        frequencyFirst = KFrequency.of(ItemStack.of(nbt.getCompound("FrequencyFirst")));
        frequencyLast = KFrequency.of(ItemStack.of(nbt.getCompound("FrequencyLast")));
    }
    ...
    public void setFrequency(boolean first, ItemStack stack) {
        ...
        if (first)
            frequencyFirst = KFrequency.of(stack);
        else
            frequencyLast = KFrequency.of(stack);
    ...
    private KRedstoneLinkNetworkHandler getHandler() {
        return CreateKinetic.REDSTONE_LINK_NETWORK_HANDLER;
    }
