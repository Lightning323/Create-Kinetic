...
public class KSmartBlockEntityRenderer<T extends SmartBlockEntity> extends SafeBlockEntityRenderer<T> {

    public KSmartBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    }
    ...
    protected void renderSafe(T blockEntity, float partialTicks, PoseStack ms, MultiBufferSource buffer, int light,
        ...
        KLinkRenderer.renderOnBlockEntity(blockEntity, partialTicks, ms, buffer, light, overlay);
    }
