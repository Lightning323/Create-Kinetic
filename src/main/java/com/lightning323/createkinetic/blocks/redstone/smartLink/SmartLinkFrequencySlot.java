...
public class SmartLinkFrequencySlot extends ValueBoxTransform.Dual {

	public SmartLinkFrequencySlot(boolean first) {
		super(first);
	}
	...
	public Vec3 getLocalOffset(LevelAccessor level, BlockPos pos, BlockState state) {
		Direction facing = state.getValue(SmartLinkBlock.FACING);
