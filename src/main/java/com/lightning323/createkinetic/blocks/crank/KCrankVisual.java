...
public class KCrankVisual extends KineticBlockEntityVisual<KCrankBlockEntity> implements SimpleDynamicVisual {
	...
	public KCrankVisual(VisualizationContext modelManager, KCrankBlockEntity blockEntity, float partialTick) {
		...
		rotatingModel.setup(KCrankVisual.this.blockEntity)
