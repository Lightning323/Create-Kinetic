...
public class BallastTankRenderer extends SafeBlockEntityRenderer<BallastTankBlockEntity> {

	public BallastTankRenderer(BlockEntityRendererProvider.Context context) {}

	@Override
	protected void renderSafe(BallastTankBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
	...
	@Override
	public boolean shouldRenderOffScreen(BallastTankBlockEntity be) {
