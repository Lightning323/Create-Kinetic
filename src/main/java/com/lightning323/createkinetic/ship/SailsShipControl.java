...
//        }
        ...
        if (numSails > 0) {
            ...
            if (KineticConfig.enableWind) {
                ...
                double windDirection = 45;//ServerWindManager.getWindDirection(world, shipPos2); //in degrees
                double windStrength = 1.0;//ServerWindManager.getWindStrength(world, shipPos3); // -1.0 -- 1.0
