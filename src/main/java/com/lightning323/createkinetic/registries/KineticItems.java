...
import com.lightning323.createkinetic.blocks.sail.CustomPulley;
...
public class KineticItems {
    ...
    public static final BlockEntry<CustomPulley> ROPE_PULLEY = REGISTRATE.block("rope_pulley", CustomPulley::new)
            .initialProperties(SharedProperties::stone)
            .properties(p -> p.mapColor(MapColor.PODZOL))
            .properties(p -> p.noOcclusion())
            .addLayer(() -> RenderType::cutoutMipped)
            .transform(axeOrPickaxe())
            .lang("Retractable Sail")
