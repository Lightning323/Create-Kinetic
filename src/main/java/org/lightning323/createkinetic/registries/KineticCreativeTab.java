...
public class KineticCreativeTab {
    ...
    private static final ResourceLocation TOOLS_SECTION = ResourceLocation.fromNamespaceAndPath(CreateKinetic.ID, "kinetic_creative");
    ...
    public static synchronized void registerAeronauticsSections() {
        ...
        //TODO: We may want to use these for something
