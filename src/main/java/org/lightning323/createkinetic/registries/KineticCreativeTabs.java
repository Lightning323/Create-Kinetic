...
//        registerSectionItem(CREATIVE_SECTION, "creative_physics_staff", () -> SimItems.PHYSICS_STAFF.get());
//        registerSectionItem(CREATIVE_SECTION, "auto_glue", () -> ModItems.AUTO_GLUE.get());
//        registerSectionItem(CREATIVE_SECTION, "creative_thruster", () -> KineticBlocks.CREATIVE_THRUSTER_BLOCK.get().asItem());
//        registerSectionItem(CREATIVE_SECTION, "creative_vector_thruster", () -> KineticBlocks.CREATIVE_VECTOR_THRUSTER_BLOCK.get().asItem());
//        registerSectionItem(CREATIVE_SECTION, "assembler_stick", () -> ModItems.ASSEMBLER_STICK.get());
//        registerSectionItem(CREATIVE_SECTION, "glued_contraption_mover", () -> ModItems.GLUED_CONTRAPTION_MOVER.get());
//        registerSectionItem(CREATIVE_SECTION, "glued_contraption_cloner", () -> ModItems.GLUED_CONTRAPTION_CLONER.get());
//        registerSectionItem(CREATIVE_SECTION, "contraption_remover", () -> ModItems.CONTRAPTION_REMOVER.get());
