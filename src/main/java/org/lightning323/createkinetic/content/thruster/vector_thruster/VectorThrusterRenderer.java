...
public final class VectorThrusterRenderer {
    ...
    public static void renderThruster(VectorThruster_I vbe, float partialTick, PoseStack ms, MultiBufferSource buffer, int light, int overlay) {
        ...
        renderThruster(vbe, partialTick, ms, buffer, light, overlay, state, bodyModel, flapTop, flapBottom, flapLeft, flapRight);
    }

    public static void renderThruster(VectorThruster_I vbe, float partialTick, PoseStack ms, MultiBufferSource buffer,
        ...
        float xAxis = Mth.clamp(vbe.getInterpolatedVectorX(partialTick), -1.0f, 1.0f);
        float yAxis = Mth.clamp(vbe.getInterpolatedVectorY(partialTick), -1.0f, 1.0f);
        ...
        float flapProgress = Mth.clamp(vbe.getInterpolatedFlapProgress(partialTick), 0.0f, 1.0f);
