...
public class CreativeTab {
    ...
    public static final RegistryObject<CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("createkinetic_tab",
            () -> CreativeModeTab.builder().withTabsBefore(CreativeModeTabs.COMBAT).icon(() ->
                    SHIP_TOTEM.get().getDefaultInstance()).displayItems((parameters, output) -> {
